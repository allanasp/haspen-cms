...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Create GIN index for custom permissions
        DB::statement('CREATE INDEX IF NOT EXISTS space_user_permissions_gin_idx ON space_user USING GIN (custom_permissions)');
    }
